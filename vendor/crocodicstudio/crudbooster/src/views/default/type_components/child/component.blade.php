				...
				<div class='col-sm-10'>
					<div class="panel panel-default">
								...
								<div class="col-sm-10">
									...
									<div id='{{$name_column}}' class="input-group">
								      ...
								      <span class="input-group-btn">
								        <button class="btn btn-primary" onclick="showModal{{$name_column}}()" type="button"><i class='fa fa-search'></i>Procurar Produto</button>
								      </span>
								    </div><!-- /input-group -->
						...
						<div class="panel-footer" align="right">
							<input type='button' class='btn btn-default' id="btn-reset-form-{{$name}}" onclick="resetForm{{$name}}()" value='Reset'/>
							<input type='button' id='btn-add-table-{{$name}}' class='btn btn-primary' onclick="addToTable{{$name}}()" value='Adicionar ao Carrinho'/>
						</div>
					</div>
				</div>
			</div>
