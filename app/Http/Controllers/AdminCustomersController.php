<?php namespace App\Http\Controllers;
	...
	class AdminCustomersController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Endereço','name'=>'address','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Telefone','name'=>'phone','type'=>'number','validation'=>'required|numeric','width'=>'col-sm-10'];
