<?php namespace App\Http\Controllers;
	...
	class AdminProductsStockController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Criado por","name"=>"cms_users_id","join"=>"cms_users,name"];
			...
			$this->form[] = ['label'=>'Stock In','name'=>'stock_in','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10','value'=>0];
			$this->form[] = ['label'=>'Stock Out','name'=>'stock_out','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10','value'=>0];
