<?php namespace App\Http\Controllers;
	...
	class AdminOrdersController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Numero do Pedido","name"=>"order_number"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Cliente','name'=>'customers_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'customers,name','datatable_format'=>"name,' - ',phone"];
			$this->form[] = ['label'=>'Numero do Pedido','name'=>'order_number','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10','value'=>$order_number,'readonly'=>true];


			$columns = [];
			$columns[] = ['label'=>'Produto','name'=>'products_id','type'=>'datamodal','datamodal_table'=>'products','datamodal_columns'=>'name,sku,sell_price,stock','datamodal_select_to'=>'sell_price:products_price,sku:products_sku','required'=>true];
			$columns[] = ['label'=>'SKU','name'=>'products_sku','type'=>'text','readonly'=>true,'required'=>true];
			$columns[] = ['label'=>'Preço','name'=>'products_price','type'=>'number','readonly'=>true,'required'=>true];
			$columns[] = ['label'=>'Quantidade','name'=>'quantity','type'=>'number','required'=>true];
